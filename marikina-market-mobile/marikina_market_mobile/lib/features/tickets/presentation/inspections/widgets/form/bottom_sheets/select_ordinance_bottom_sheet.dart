...
class _SelectOrdinanceBottomSheetState
    extends State<SelectOrdinanceBottomSheet> {
  List<Ordinance> _selectedOrdinance = [];
  ...
  void initState() {
    super.initState();
    _selectedOrdinance = widget.ordinances;
        ...
        if (state is OrdinanceSelectionLoaded) {
          setState(() {
            ...
            _availableOrdinance = widget.isWarningTicket
                ? ordinances.where((o) => o.severity == Severity.minor).toList()
                : ordinances;
          });
        }
                  ...
                  Wrap(
                    ...
                    children: _selectedOrdinance.map((ordinance) {
                      return Chip(
                        ...
                        onDeleted: () => setState(
                          () => _selectedOrdinance.remove(ordinance),
                        ),
                      );
                    }).toList(),
                  ),
                ...
                Expanded(
                  child: BlocBuilder<InspectionBloc, InspectionState>(
                    builder: (context, state) {
                      if (state is OrdinanceSelectionLoading &&
                          _availableOrdinance.isEmpty) {
                        return SizedBox(
                      ...
                      if (_availableOrdinance.isNotEmpty) {
                        final ordinanceList = _availableOrdinance
                            .where(
                              (o) =>
                                  o.ordinanceNo.toLowerCase().contains(
                                    _searchQuery.toLowerCase(),
                                  ) ||
                                  o.title.toLowerCase().contains(
                                    _searchQuery.toLowerCase(),
                                  ),
                            )
                            .toList();
                          ...
                          children: [
                            ...
                            Expanded(
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  bool isSelected = _selectedOrdinance.any(
                                    (o) => o.id == ordinance.id,
                                  );
                                  ...
                                  return AnimatedContainer(
                                    ...
                                    child: ListTile(
                                      ...
                                      subtitle: Text(ordinance.ordinanceCode),
                                    ),
                                  );
                                },
                              ),
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: _selectedOrdinance.isEmpty
                                    ? null
                                    : () {
                                        _confirmSelection();
                                      },
