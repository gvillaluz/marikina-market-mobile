                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ProfileDetailRow(label: 'LAST NAME', value: state.user.lastName),
                          Divider(height: 1, color: AppColors.lightGrey.withValues(alpha: 0.30),),
                          ProfileDetailRow(label: 'FIRST NAME', value: state.user.firstName),
                          Divider(height: 1, color: AppColors.lightGrey.withValues(alpha: 0.30),),
                          ProfileDetailRow(label: 'MIDDLE NAME', value: state.user.middleName),
                          Divider(height: 1, color: AppColors.lightGrey.withValues(alpha: 0.30),),
                          ProfileDetailRow(label: 'ACCOUNT STATUS', value: null, status: state.user.status),
                          Divider(height: 1, color: AppColors.lightGrey.withValues(alpha: 0.30),),
                          ProfileDetailRow(label: 'CREATED AT', value: DateTimeFormatter.getDate(state.user.createdAt)),
                        ],
                      ),
                    ),
                    ...
                    AppPrimaryButton(
                      ...
                      onPressed: () {
                        context.pushNamed(Routes.editProfileName, extra: state.user);
                      },
                    ),
                    ...
                    AppOutlinedBtn(
                      ...
                      onPressed: () {
                        context.pushNamed(Routes.changePasswordName, extra: state.user);
                      }, 
                    ...
                    AppOutlinedBtn(
                      ...
                      backgroundColor: AppColors.secondaryRed.withValues(alpha: 0.50)
                    )
                  ],
                ),
              ),
